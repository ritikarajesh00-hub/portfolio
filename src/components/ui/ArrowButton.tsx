...
import { ArrowCircleIcon, ArrowDownIcon, ArrowUpRightIcon } from "./icons";
 ...
 *
 * `icon="down"` swaps in a downward arrow for CTAs that scroll the page.
 */
export function ArrowButton({
  ...
  return (
    ...
    >
      ...
      {lg ? icon === "down" ? <ArrowDownIcon /> : <ArrowUpRightIcon /> : <ArrowCircleIcon />}
    </Link>
  );
}
